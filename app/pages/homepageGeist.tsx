...
export function PageHomeGeist({
  ...
  return (
    <Container className="flex-1 !mb-6" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif' }}>
      <Header>
        <h2 className="font-bold text-3xl text-balance" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important', fontWeight: '600', fontSize: '2.25rem' }}>Miden is the Edge Blockchain</h2>
      ...
      <div className="mt-16">
        <h2 className="font-bold text-2xl text-balance" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important', fontWeight: '600', fontSize: '1.625rem' }}>
          The way blockchains were always meant to work
        </h2>
        <ol className="flex flex-col gap-4 md:gap-6 mt-6 font-geist" style={{ fontSize: '16px' }}>
          <li>
            <h4 className="mb-1 font-bold text-primary" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important' }}>It scales</h4>
            <p style={{ fontSize: '16px !important', fontWeight: 'normal !important', fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important' }}>
          ...
          <li>
            <h4 className="mb-1 font-bold text-primary" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important' }}>It's private</h4>
            <p style={{ fontSize: '16px !important', fontWeight: 'normal !important', fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important' }}>
          ...
          <li>
            <h4 className="mb-1 font-bold text-primary" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important' }}>It's safe</h4>
            <p style={{ fontSize: '16px !important', fontWeight: 'normal !important', fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif !important' }}>

...
export function PageHomeGeist({
  ...
  return (
    <Container className="flex-1 !mb-6" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif' }}>
      <Header>
        <h2 style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif' }}>Miden is the Edge Blockchain</h2>
        <p>
      ...
      <div className="mt-16">
        <h3 className="font-semibold text-xl text-balance" style={{ fontFamily: 'Geist, ui-sans-serif, system-ui, sans-serif' }}>
          The way blockchains were always meant to work
        </h3>
        <ol className="flex flex-col gap-4 md:gap-6 mt-6 text-sm font-geist">
          <li>

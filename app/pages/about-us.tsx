    ...
    return (
        <Container className="!mb-6">
            ...
            <div className="border-t !border-gray-300/60 py-4 md:py-8 text-black [&_p]:text-sm [&_h3]:text-xl [&_h2]:text-2xl [&_h1]:text-28">
                <h2 className="mb-4">Media Kit</h2>
                <p className="mb-4">A quick places for you to find brand and media assets</p>

                <div className="mt-6">
                    <Link to="https://drive.google.com/drive/folders/1jRxP0LtQHwO389h5vfysigNTSkuuGBKa?usp=drive_link" target="_blank" className="text-primary/90 hover:text-primary italic underline text-sm font-medium">Click here</Link>
                </div>
            </div>
            ...
            <div className="border-t !border-gray-300/60 py-4 md:py-8 text-black [&_p]:text-sm [&_h3]:text-xl [&_h2]:text-2xl [&_h1]:text-28">
                ...
                <div className="mt-6">
                    <Link to="/careers" prefetch="intent" className="text-primary/90 hover:text-primary italic underline text-sm font-medium">Open roles</Link>
                </div>
            </div>

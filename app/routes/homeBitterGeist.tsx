...
import { PageHomeBitterGeist, type Investor } from "~/pages/homepageBitterGeist";
...
export default function RouteHomeBitterGeist() {
  return <PageHomeBitterGeist items={items} />;
}

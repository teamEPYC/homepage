...
import { PageHomeIBMSerifRobotoSerif, type Investor } from "~/pages/homepageIBMSerifRobotoSerif";
...
export default function RouteHomeIBMSerifRobotoSerif() {
  return <PageHomeIBMSerifRobotoSerif items={items} />;
}

...
import { PageHomePoppinsRaleway, type Investor } from "~/pages/homepagePoppinsRaleway";
...
export default function RouteHomePoppinsRaleway() {
  return <PageHomePoppinsRaleway items={items} />;
}

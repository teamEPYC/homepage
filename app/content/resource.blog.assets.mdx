...
For the latest, tune in to our X account or Telegram channel (links in footer). And if you’re interested in (or perplexed by) zero-knowledge and Miden, [check out the docs](https://0xmiden.github.io/miden-docs/).

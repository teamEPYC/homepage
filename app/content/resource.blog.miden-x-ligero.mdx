...
Miden and Ligero are complementary. Miden runs on a client-side model, where proofs are generated locally and verified onchain. Ligero extends this approach. By integrating Ligero’s prover alongside Miden’s, the stack gains both diversity and cutting-edge techniques that have been validated by Google. 

...
1. Token swap initiation: Acct1 and Acct2 want to trade on a Uniswap-like contract.
...
3. Token swap finalization: Acct1 and Acct2 now get their swapped tokens back.

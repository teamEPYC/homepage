...
We now have a **Miden devnet** explicitly for experimentation.  
See: [devnet.midenscan.com](https://devnet.midenscan.com/) & [status.devnet.miden.io](https://status.devnet.miden.io/)
...
**New to Miden and ready to try things out? The Quick Start guide will walk you through setting up your environment and spinning up your first Miden project in no time:**  
[https://docs.miden.xyz/quick-start/](https://docs.miden.xyz/quick-start/)
